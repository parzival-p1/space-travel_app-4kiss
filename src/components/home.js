            ...
            <section className="home px-5">
                <div className="overlay">
                    <article className="lg:w-1/2 lg:mr-20">
                        ...
                        <p className="text-gray-400">Let's face it; if you want to go to space, you might as well genuinely go to edge of it. Well, sit back, and relax because we'll give you a truly out of this world experience</p>
                    </article>
